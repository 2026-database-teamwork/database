...
const totalCost = computed(() => baseCost.value + insuranceCost.value + addonsCost.value);
        ...
        <div class="lg:w-[400px] flex-shrink-0">
          <div class="bg-ink text-snow p-[32px] rounded-[32px] sticky top-[100px]">
            ...
            <div class="border-t border-snow/20 pt-4 mb-8">
              ...
              <div class="text-heading-sm font-bold tracking-heading-sm text-snow">₩{{ totalCost.toLocaleString() }}</div>
            </div>
